...
const Canvas = () => {
  ...
  const tools = [
    ...
    { id: 'text', icon: TextCursor, label: 'Text' },
  ...
  return (
    <div className="h-screen flex flex-col bg-gray-50">
      ...
      <div className="flex-1 flex">
        {/* Left Sidebar - Tools */}
        <div className="w-20 bg-white border-r border-gray-200 flex flex-col items-center py-4 space-y-2 overflow-y-auto">
          {tools.map((tool) => {
            ...
            return (
              <button
                ...
                className={`w-14 h-14 flex flex-col items-center justify-center rounded-lg transition-all duration-300 transform hover:scale-110 ${
                  selectedTool === tool.id
                    ? 'bg-primary-100 text-primary-600 shadow-lg animate-pulse'
